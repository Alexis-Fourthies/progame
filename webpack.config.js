...
module.exports = {
  ...
  module: {
    rules: [
      ...
      {
        // Pour les images :
        // pour tous les fichiers contenant les extensions suivantes : "png", "jpg", "jpeg" et "gif", on appelle le loader "assetModule" 
      ...
      {
        // Pour les icones :
        // pour tous les fichiers contenant les extensions suivantes : "svg", on appelle le loader "assetModule" 
        test: /\.svg$/i,
        type: 'asset/resource',
        generator: {
